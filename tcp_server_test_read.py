...
class Reliability_tests(unittest.TestCase):
    ...
    def test_nofile(self):
        ...
        with socket.socket(socket.AF_INET,socket.SOCK_STREAM) as sock:
            ...
            packet = tftpclient.sendRRQWRQ(1,self.file_name, sock)
            ...
            errormessage = tftpclient.unpack_err_read_test(message,confirm_code)
            self.assertEqual(errormessage[2].decode(),"File Not Found")
     ...
     #       message = sock.recv(516)
      #      confirm_code = tftpclient.autentication_message(message)
       #     server_proccess.send_signal(signal.SIGINT)   # send Ctrl-C signal
        ...
        #    self.assertEqual(confirm_code,4)
